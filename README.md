...
casual — rather than pins or numbers. The frame fits the stays: Europe
fills the page until a place outside it opens the view back toward the
world. Location reads expire
