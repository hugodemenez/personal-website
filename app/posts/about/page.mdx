...
import SubstackPosts from '../../about/SubstackPosts';
import YoutubeVideos from '../../about/YoutubeVideos';
import YearsSince from '@/components/years-parser';
...
For the past <Suspense fallback={<span>...</span>}>{<YearsSince startYear={2018} />}</Suspense> years,
...
For the past <Suspense fallback={<span>...</span>}>{<YearsSince startYear={2023} />}</Suspense> years, I've been focused on discretionary trading strategies for US stocks,
