...
import YoutubeVideos from '../../../components/about/YoutubeVideos';
...
For the past <Suspense fallback={<span>...</span>}>{new Date().getFullYear() - 2018} years</Suspense>,
...
For the past <Suspense fallback={<span>...</span>}>{new Date().getFullYear() - 2023} years</Suspense>, I've been focused on discretionary trading strategies for US stocks,
