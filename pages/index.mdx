...
import CustomSubstackFeed from '../components/CustomSubstackFeed'

## Welcome!

### My Journey Through Financial Markets

For the past 5 years, I've been exploring the exciting world of trading and investing. My journey began with developing a [seasonal strategy](/posts/seasonal-strategy) rooted in fundamental company analysis. It then evolved into building [trading algorithms](/posts/trading-algorithms) for cryptocurrency scalping. Currently, I'm focused on discretionary trading strategies for US stocks, leveraging volume profile and orderbook analysis.
